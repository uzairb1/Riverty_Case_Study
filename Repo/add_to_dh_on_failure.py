...
dataset_urn = make_dataset_urn(platform="snowflake", name="covid_data.vaccine_data.data_us", env="PROD")
column = "date"
...
if need_write:
    ...
    graph.emit(event)
    print(f"Documentation added to dataset {dataset_urn}")

else:
    print("Documentation already exists and is identical, omitting write")
